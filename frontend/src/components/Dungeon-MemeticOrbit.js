...
const Memeticorbit = ({ config, intrasubModetext, navigate, callMode, setisLoading, txupdate, setTxupdate, setisError, setErrMsg, erc721Abi, erc20Abi, dunMoABI, mintStOPTABI, salonABI, slot1ABI, badgeClaimerABI }) => {
    ...
    React.useEffect(() => {
        ...
        const thefetch = async () => {
            ...
            try {
                res_main_char = data[0].status === 'success' ? await fetch(data[0].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_char = res_main_char !== null ? await res_main_char.json() : {image: null, name: null}
            const nftEQ_main_char_Img = nft_main_char.image !== null ? nft_main_char.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_acc1 = data[1].status === 'success' ? await fetch(data[1].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_acc = res_main_acc1 !== null ? await res_main_acc1.json() : {image: null, name: null}
            const nftEQ_main_acc_Img = nft_main_acc.image !== null ? nft_main_acc.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_back = data[2].status === 'success' ? await fetch(data[2].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_back = res_main_back !== null ? await res_main_back.json() : {image: null, name: null}
            const nftEQ_main_back_Img = nft_main_back.image !== null ? nft_main_back.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_shoes = data[3].status === 'success' ? await fetch(data[3].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_shoes = res_main_shoes !== null ? await res_main_shoes.json() : {image: null, name: null}
            const nftEQ_main_shoes_Img = nft_main_shoes.image !== null ? nft_main_shoes.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_wp1 = data[4].status === 'success' ? await fetch(data[4].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_wp1 = res_main_wp1 !== null ? await res_main_wp1.json() : {image: null, name: null}
            const nftEQ_main_wp1_Img = nft_main_wp1.image !== null ? nft_main_wp1.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_cloth = data[5].status === 'success' ? await fetch(data[5].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_cloth = res_main_cloth !== null ? await res_main_cloth.json() : {image: null, name: null}
            const nftEQ_main_cloth_Img = nft_main_cloth.image !== null ? nft_main_cloth.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_hat = data[6].status === 'success' ? await fetch(data[6].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_hat = res_main_hat !== null ? await res_main_hat.json() : {image: null, name: null}
            const nftEQ_main_hat_Img = nft_main_hat.image !== null ? nft_main_hat.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_wp2 = data[7].status === 'success' ? await fetch(data[7].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_wp2 = res_main_wp2 !== null ? await res_main_wp2.json() : {image: null, name: null}
            const nftEQ_main_wp2_Img = nft_main_wp2.image !== null ? nft_main_wp2.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_acc2 = data[8].status === 'success' ? await fetch(data[8].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_acc2 = res_main_acc2 !== null ? await res_main_acc2.json() : {image: null, name: null}
            const nftEQ_main_acc2_Img = nft_main_acc2.image !== null ? nft_main_acc2.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_acc3 = data[9].status === 'success' ? await fetch(data[9].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_acc3 = res_main_acc3 !== null ? await res_main_acc3.json() : {image: null, name: null}
            const nftEQ_main_acc3_Img = nft_main_acc3.image !== null ? nft_main_acc3.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_acc4 = data[10].status === 'success' ? await fetch(data[10].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_acc4 = res_main_acc4 !== null ? await res_main_acc4.json() : {image: null, name: null}
            const nftEQ_main_acc4_Img = nft_main_acc4.image !== null ? nft_main_acc4.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_acc5 = data[11].status === 'success' ? await fetch(data[11].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_acc5 = res_main_acc5 !== null ? await res_main_acc5.json() : {image: null, name: null}
            const nftEQ_main_acc5_Img = nft_main_acc5.image !== null ? nft_main_acc5.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_acc6 = data[12].status === 'success' ? await fetch(data[12].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_acc6 = res_main_acc6 !== null ? await res_main_acc6.json() : {image: null, name: null}
            const nftEQ_main_acc6_Img = nft_main_acc6.image !== null ? nft_main_acc6.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_soul = data[13].status === 'success' ? await fetch(data[13].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_soul = res_main_soul !== null ? await res_main_soul.json() : {image: null, name: null}
            const nftEQ_main_soul_Img = nft_main_soul.image !== null ? nft_main_soul.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_main_badge = data[14].status === 'success' ? await fetch(data[14].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_main_badge = res_main_badge !== null ? await res_main_badge.json() : {image: null, name: null}
            const nftEQ_main_badge_Img = nft_main_badge.image !== null ? nft_main_badge.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_char_ss1 = data[15].status === 'success' ? await fetch(data[15].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_char_ss1 = res_meme_char_ss1 !== null ? await res_meme_char_ss1.json() : {image: null, name: null}
            const nftEQ_meme_char_ss1_Img = nft_meme_char_ss1.image !== null ? nft_meme_char_ss1.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_hat_ss1 = data[16].status === 'success' ? await fetch(data[16].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_hat_ss1 = res_meme_hat_ss1 !== null ? await res_meme_hat_ss1.json() : {image: null, name: null}
            const nftEQ_meme_hat_ss1_Img = nft_meme_hat_ss1.image !== null ? nft_meme_hat_ss1.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_cloth_ss1 = data[17].status === 'success' ? await fetch(data[17].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_cloth_ss1 = res_meme_cloth_ss1 !== null ? await res_meme_cloth_ss1.json() : {image: null, name: null}
            const nftEQ_meme_cloth_ss1_Img = nft_meme_cloth_ss1.image !== null ? nft_meme_cloth_ss1.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_acc_ss1 = data[18].status === 'success' ? await fetch(data[18].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_acc_ss1 = res_meme_acc_ss1 !== null ? await res_meme_acc_ss1.json() : {image: null, name: null}
            const nftEQ_meme_acc_ss1_Img = nft_meme_acc_ss1.image !== null ? nft_meme_acc_ss1.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_back_ss1 = data[19].status === 'success' ? await fetch(data[19].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_back_ss1 = res_meme_back_ss1 !== null ? await res_meme_back_ss1.json() : {image: null, name: null}
            const nftEQ_meme_back_ss1_Img = nft_meme_back_ss1.image !== null ? nft_meme_back_ss1.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_shoes_ss1 = data[20].status === 'success' ? await fetch(data[20].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_shoes_ss1 = res_meme_shoes_ss1 !== null ? await res_meme_shoes_ss1.json() : {image: null, name: null}
            const nftEQ_meme_shoes_ss1_Img = nft_meme_shoes_ss1.image !== null ? nft_meme_shoes_ss1.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_weapon_ss1 = data[21].status === 'success' ? await fetch(data[21].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_weapon_ss1 = res_meme_weapon_ss1 !== null ? await res_meme_weapon_ss1.json() : {image: null, name: null}
            const nftEQ_meme_weapon_ss1_Img = nft_meme_weapon_ss1.image !== null ? nft_meme_weapon_ss1.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_char_ss2 = data[27].status === 'success' ? await fetch(data[27].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_char_ss2 = res_meme_char_ss2 !== null ? await res_meme_char_ss2.json() : {image: null, name: null}
            const nftEQ_meme_char_ss2_Img = nft_meme_char_ss2.image !== null ? nft_meme_char_ss2.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_hat_ss2 = data[28].status === 'success' ? await fetch(data[28].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_hat_ss2 = res_meme_hat_ss2 !== null ? await res_meme_hat_ss2.json() : {image: null, name: null}
            const nftEQ_meme_hat_ss2_Img = nft_meme_hat_ss2.image !== null ? nft_meme_hat_ss2.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_cloth_ss2 = data[29].status === 'success' ? await fetch(data[29].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_cloth_ss2 = res_meme_cloth_ss2 !== null ? await res_meme_cloth_ss2.json() : {image: null, name: null}
            const nftEQ_meme_cloth_ss2_Img = nft_meme_cloth_ss2.image !== null ? nft_meme_cloth_ss2.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_acc_ss2 = data[30].status === 'success' ? await fetch(data[30].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            ...
            const nftEQ_meme_acc_ss2_Img = nft_meme_acc_ss2.image !== null ? nft_meme_acc_ss2.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_back_ss2 = data[31].status === 'success' ? await fetch(data[31].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_back_ss2 = res_meme_back_ss2 !== null ? await res_meme_back_ss2.json() : {image: null, name: null}
            const nftEQ_meme_back_ss2_Img = nft_meme_back_ss2.image !== null ? nft_meme_back_ss2.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_shoes_ss2 = data[32].status === 'success' ? await fetch(data[32].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_shoes_ss2 = res_meme_shoes_ss2 !== null ? await res_meme_shoes_ss2.json() : {image: null, name: null}
            const nftEQ_meme_shoes_ss2_Img = nft_meme_shoes_ss2.image !== null ? nft_meme_shoes_ss2.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_weapon_ss2 = data[33].status === 'success' ? await fetch(data[33].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_weapon_ss2 = res_meme_weapon_ss2 !== null ? await res_meme_weapon_ss2.json() : {image: null, name: null}
            const nftEQ_meme_weapon_ss2_Img = nft_meme_weapon_ss2.image !== null ? nft_meme_weapon_ss2.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_char_ss3 = data[35].status === 'success' ? await fetch(data[35].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_char_ss3 = res_meme_char_ss3 !== null ? await res_meme_char_ss3.json() : {image: null, name: null}
            const nftEQ_meme_char_ss3_Img = nft_meme_char_ss3.image !== null ? nft_meme_char_ss3.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_hat_ss3 = data[36].status === 'success' ? await fetch(data[36].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_hat_ss3 = res_meme_hat_ss3 !== null ? await res_meme_hat_ss3.json() : {image: null, name: null}
            const nftEQ_meme_hat_ss3_Img = nft_meme_hat_ss3.image !== null ? nft_meme_hat_ss3.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_cloth_ss3 = data[37].status === 'success' ? await fetch(data[37].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_cloth_ss3 = res_meme_cloth_ss3 !== null ? await res_meme_cloth_ss3.json() : {image: null, name: null}
            const nftEQ_meme_cloth_ss3_Img = nft_meme_cloth_ss3.image !== null ? nft_meme_cloth_ss3.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_acc_ss3 = data[38].status === 'success' ? await fetch(data[38].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            ...
            const nftEQ_meme_acc_ss3_Img = nft_meme_acc_ss3.image !== null ? nft_meme_acc_ss3.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_back_ss3 = data[39].status === 'success' ? await fetch(data[39].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_back_ss3 = res_meme_back_ss3 !== null ? await res_meme_back_ss3.json() : {image: null, name: null}
            const nftEQ_meme_back_ss3_Img = nft_meme_back_ss3.image !== null ? nft_meme_back_ss3.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_shoes_ss3 = data[40].status === 'success' ? await fetch(data[40].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_shoes_ss3 = res_meme_shoes_ss3 !== null ? await res_meme_shoes_ss3.json() : {image: null, name: null}
            const nftEQ_meme_shoes_ss3_Img = nft_meme_shoes_ss3.image !== null ? nft_meme_shoes_ss3.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
            ...
            try {
                res_meme_weapon_ss3 = data[41].status === 'success' ? await fetch(data[41].result.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/")) : null
            } catch {}
            const nft_meme_weapon_ss3 = res_meme_weapon_ss3 !== null ? await res_meme_weapon_ss3.json() : {image: null, name: null}
            const nftEQ_meme_weapon_ss3_Img = nft_meme_weapon_ss3.image !== null ? nft_meme_weapon_ss3.image.replace("ipfs://", "https://gateway.pinata.cloud/ipfs/") : null
                        ...
                        <div style={{background: "none rgba(255, 255, 255, 0.1)", backdropFilter: "blur(14px)", boxShadow: "none", border: 0, justifyContent: "space-around", padding: "30px", width: "1140px", height: "fit-content", display: "flex", flexDirection: "row", textAlign: "left", flexWrap: "wrap"}} className="nftCard">
                            <div style={{background: "#2f1a52", color: "#fff", width: "370px", height: "360px", margin: "20px", padding: "20px", display: "flex", flexDirection: "column", justifyContent: "space-around", boxShadow: "3px 3px 0 #0d0a1f"}}>
                                ...
                                <div style={{height: "180px", width: "100%", padding: "20px 0", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", textAlign: "center", letterSpacing: 1}} className="bold">
                                    ...
                                    <img src="https://gateway.pinata.cloud/ipfs/bafkreifvhxrmsfjzwogj4owx62x6zbsywgyjx24cmdtusfjm5svk4hohji" width="100px" alt="Can not load metadata." />
                                    <div style={{width: "100%", display: "flex", flexDirection: "row", justifyContent: "space-between"}}>
                            ...
                            <div className='slotbox noscroll'>
                                <div style={{position: "relative", width: "150px", height: "400px", padding: "20px 20px 20px 0", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between"}}>
                                    {ss3HatSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/bafybeihcaime52xjf7b2ysgsfvsrg2jb5bmwa72grvnm5yqimaar44cnv4" width="100px" alt="Can not load metadata." style={{filter: 'grayscale(1)'}} />
                                    }
                                    ...
                                    {ss3ClothSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/bafkreih5olhdb33tdz7ujof7d4ykjufay7odefvvby47jr62o275cgerta" width="100px" alt="Can not load metadata." style={{filter: 'grayscale(1)'}} />
                                    }
                                    ...
                                    {ss3ShoesSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/bafybeiajrhbrxzhfkcsb6pazkrvgxamoij3jnlvljggi27wbidavtsbese" width="100px" alt="Can not load metadata." style={{filter: 'grayscale(1)'}} />
                                    }
                                    ...
                                    {nft.length > 0 ?
                                        <>
                                            {ss3CharacterSlot !== null ?
                                                ...
                                                <img src="https://gateway.pinata.cloud/ipfs/bafkreibl25he5u74rw2mi24xhjl4yurmhoe6upn4qcbi5kn75e5uaz2ksa" width="300px" alt="Can not load metadata." style={{filter: 'grayscale(1)'}} />
                                            }
                                        </> :
                                        <div style={{width: "300px", height: "300px", borderRadius: "16px", border: "1px solid gray", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                            <ThreeDots fill="#5f6476" />
                                ...
                                <div style={{position: "relative", width: "150px", height: "400px", padding: "20px 0 20px 20px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between"}}>
                                    {ss3AccSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/bafybeiftowtfdkgeriogbaaoj7dhgnx5hcx2izqla3f4vnwrwtifbu2yoa" width="100px" alt="Can not load metadata." style={{filter: 'grayscale(1)'}} />
                                    }
                                    ...
                                    {ss3BackSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/bafkreibnpsqclgnzwv6m2lrdu6snkmduuumcdobpllkj7aaoklyvt2hqaa" width="100px" alt="Can not load metadata." style={{filter: 'grayscale(1)'}} />
                                    }
                                    ...
                                    {ss3WeaponSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/bafybeihsvjagwtvlduxlca4pkbyafl3wjqlpuur5hijy5apmdn4ldiohtq" width="100px" alt="Can not load metadata." style={{filter: 'grayscale(1)'}} />
                                    }
                        ...
                        <div style={{background: "none rgba(255, 255, 255, 0.1)", backdropFilter: "blur(14px)", boxShadow: "none", border: 0, justifyContent: "space-around", padding: "30px", width: "1140px", height: "fit-content", display: "flex", flexDirection: "row", textAlign: "left", flexWrap: "wrap"}} className="nftCard">
                            <div style={{background: "#2f1a52", color: "#fff", width: "370px", height: "360px", margin: "20px", padding: "20px", display: "flex", flexDirection: "column", justifyContent: "space-around", boxShadow: "3px 3px 0 #0d0a1f"}}>
                                ...
                                <div style={{height: "180px", width: "100%", padding: "20px 0", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", textAlign: "center", letterSpacing: 1}} className="bold">
                                    ...
                                    <div style={{width: "100%", textAlign: "left", letterSpacing: 0.5, fontSize: "10px"}} className="light">- All meme slots must be filled to be eligible for the seasonal badge nft claiming. The season ends in 28 + 7 days.</div>
                                    <div style={{width: "100%", marginBottom: "10px", textAlign: "left", letterSpacing: 0.5, fontSize: "10px"}} className="light">- Warning: due to SC V1 critical bug, Shoes and weapon can't be unstake from L2 please stake with awareness!</div>                            
                                    <img src="https://gateway.pinata.cloud/ipfs/QmZ9tfCVpoApPyVYuB7b5frTiu6Wc5feFUuderaCKQ6LU7" width="100px" alt="Can not load metadata." />
                                    <div style={{width: "100%", display: "flex", flexDirection: "row", justifyContent: "space-between"}}>
                            ...
                            <div className='slotbox noscroll'>
                                <div style={{position: "relative", width: "150px", height: "400px", padding: "20px 20px 20px 0", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between"}}>
                                    {ss2HatSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmcJg97MWcc58JcTU4Z69phZr5iUDRXHc4H6kFKhy8iqL1" width="100px" alt="Can not load metadata." />
                                    }
                                    ...
                                    {ss2ClothSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmZEch1ACdpn1UdRA91wm7ky2bDH2QJXHg1tPKo683Xyv9" width="100px" alt="Can not load metadata." />
                                    }
                                    ...
                                    {ss2ShoesSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmQBwQeRGM68cNnFWEQKxEJvxHh8GsXGgw7rze2zDkhq6Q" width="100px" alt="Can not load metadata." />
                                    }
                                    ...
                                    {nft.length > 0 ?
                                        <>
                                            {ss2CharacterSlot !== null ?
                                                ...
                                                <img src="https://gateway.pinata.cloud/ipfs/QmRTR62zSMJiSYZ4h1HeMrcGJCnmzrphKNgaVRtM1PnxMw" width="300px" alt="Can not load metadata." />
                                            }
                                        </> :
                                        <div style={{width: "300px", height: "300px", borderRadius: "16px", border: "1px solid gray", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                            <ThreeDots fill="#5f6476" />
                                ...
                                <div style={{position: "relative", width: "150px", height: "400px", padding: "20px 0 20px 20px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between"}}>
                                    {ss2AccSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmNhfFs1kSzPYMJaYjcdqu44vUrCBQk2uD4DdkFK89KvNH" width="100px" alt="Can not load metadata." />
                                    }
                                    ...
                                    {ss2BackSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmXfGctM5uGHYU8SMwWa1bUJTosvEBwFzT2gbkhc87yKKj" width="100px" alt="Can not load metadata." />
                                    }
                                    ...
                                    {ss2WeaponSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmS2VnY8FGWR5o1rBo8cx74t2s5SYuJE5ufPEvjEeAL1cN" width="100px" alt="Can not load metadata." />
                                    }
                        ...
                        <div style={{background: "none rgba(255, 255, 255, 0.1)", backdropFilter: "blur(14px)", boxShadow: "none", border: 0, justifyContent: "space-around", padding: "30px", width: "1140px", height: "fit-content", display: "flex", flexDirection: "row", textAlign: "left", flexWrap: "wrap"}} className="nftCard">
                            <div style={{background: "#2f1a52", color: "#fff", width: "370px", height: "360px", margin: "20px", padding: "20px", display: "flex", flexDirection: "column", justifyContent: "space-around", boxShadow: "3px 3px 0 #0d0a1f"}}>
                                ...
                                <div style={{height: "180px", width: "100%", padding: "20px 0", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "center", textAlign: "center", letterSpacing: 1}} className="bold">
                                    ...
                                    <div style={{width: "100%", textAlign: "left", letterSpacing: 0.5, fontSize: "10px"}} className="light">- All meme slots must be filled to be eligible for the seasonal badge nft claiming. The season ends in 28 + 7 days.</div>
                                    <div style={{width: "100%", marginBottom: "10px", textAlign: "left", letterSpacing: 0.5, fontSize: "10px"}} className="light">- Warning: due to SC V1 critical bug, Shoes and weapon can't be unstake from L2 please stake with awareness!</div>
                                    <img src="https://gateway.pinata.cloud/ipfs/QmTaAzPsargodLJao3VPqCyGi94FwfSEKQzQjT5WNY5SA3" width="100px" alt="Can not load metadata." />
                                    <div style={{width: "100%", display: "flex", flexDirection: "row", justifyContent: "space-between"}}>
                            ...
                            <div className='slotbox noscroll'>
                                <div style={{position: "relative", width: "150px", height: "400px", padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between"}}>
                                    {ss1HatSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmSgooLEbo2MrxT3rNzFKq1fGkweGZJhV2ejPhKpAgoSWr" width="100px" alt="Can not load metadata." />
                                    }
                                    ...
                                    {ss1ClothSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmPY9gNNpai3UGtx8jSsohn3scvsioJM7AvmQLbFnBjvwq" width="100px" alt="Can not load metadata." />
                                    }
                                    ...
                                    {ss1ShoesSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmT4aYAh5veaM7fawV4MbufZBGWKFcJ4QmXdzNqmHYMxXk" width="100px" alt="Can not load metadata." />
                                    }
                                    ...
                                    {nft.length > 0 ?
                                        <>
                                            {ss1CharacterSlot !== null ?
                                                ...
                                                <img src="https://gateway.pinata.cloud/ipfs/QmViHN4xqFWr9x9t4q1QGMNanm3f7u2fBD6PU9x4ZKdyzk" width="300px" alt="Can not load metadata." />
                                            }
                                        </> :
                                        <div style={{width: "300px", height: "300px", borderRadius: "16px", border: "1px solid gray", display: "flex", justifyContent: "center", alignItems: "center"}}>
                                            <ThreeDots fill="#5f6476" />
                                ...
                                <div style={{position: "relative", width: "150px", height: "400px", padding: "20px", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between"}}>
                                    {ss1AccSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmYYCgcgbqdh59kuyuXSxWom7igRYqPnXLY4DNjL3mJpY8" width="100px" alt="Can not load metadata." />
                                    }
                                    {ss1BackSlot !== null ?
                                        <img src={ss1BackSlot} width="100px" alt="Can not load metadata." /> :
                                        <img src="https://gateway.pinata.cloud/ipfs/QmRFpQsLUgJPjgXXBeREddUVAEcyJwzqG79VJ7BeYd8LSj" width="100px" alt="Can not load metadata." />
                                    }
                                    ...
                                    {ss1WeaponSlot !== null ?
                                        ...
                                        <img src="https://gateway.pinata.cloud/ipfs/QmRKTx7BpuUicaecf4bKYSroAvedLGw3mncWAHHSfLszJc" width="100px" alt="Can not load metadata." />
                                    }
