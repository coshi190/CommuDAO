...
const DungeonArena = ({ config, setisLoading, callMode, navigate, txupdate, setTxupdate, setisError, setErrMsg, erc20Abi, erc721Abi, questAmbassABI, dunJasperABI, pvp01ABI, salonABI }) => { 
    ...
    React.useEffect(() => {
        ...
        const thefetch = async () => {
            ...
            const nftEQ = address !== null ? await readContract(config, {
                address: dunJasper,
                abi: dunJasperABI,
    ...
    }, [config, address, navigate, chain, txupdate, erc20Abi, erc721Abi, questAmbassABI, dunJasperABI, pvp01ABI, salonABI])
    ...
    const oneHit = async () => {
        ...
        try {
            ...
            if (Number(ethers.utils.formatEther(bountyAllow)) < 10) {
                let { request } = await simulateContract(config, {
                    address: jdao,
                    abi: erc20Abi,
                    functionName: 'approve',
                    args: [pvp01, ethers.constants.MaxUint256],
                })
        ...
        <>
            <div className="fieldBanner" style={{display: "flex", flexFlow: "row wrap", alignItems: "center", justifyContent: "space-between", textAlign: "left", overflow: "scroll"}}>
                <div className="SubfieldBanner pixel">
                    <div className="pixel" style={{fontSize: "75px", width: "fit-content"}}>Dungeon Arena</div>
                </div>
            ...
            {address !== null && chain !== undefined && chain.id !== 8899 ?
                ...
                <div style={{background: "rgb(0, 19, 33)", margin: "0", minHeight: "inherit", flexFlow: "row wrap", alignItems: "flex-start", justifyContent: "flex-start", overflow: "scroll"}} className="collection noscroll">
                    <div style={{background: "rgba(0, 0, 0, 0.8)", backdropFilter: "blur(20px)", margin: "50px", padding: "25px", border: "none", width: "880px", maxWidth: "100%", height: "400px", display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", flexWrap: "wrap", overflow: "scroll"}} className="nftCard noscroll">
                    ...
                    <div style={{width: "800px", margin: "0 0 80px 50px", display: "flex", flexDirection: "column", justifyContent: "flex-start", overflow: "scroll"}} className="pixel mainprofile">
                    ...
                    <div style={{width: "800px", margin: "0 0 80px 50px", display: "flex", flexDirection: "column", justifyContent: "flex-start", overflow: "scroll"}} className="pixel mainprofile">
                        <div style={{marginTop: "65px", backgroundColor: "#1C2024", border: "none", justifyContent: "space-around", padding: "20px 0", width: "600px", height: "fit-content", marginBottom: "10px", display: "flex", flexDirection: "row", textAlign: "left", flexWrap: "wrap"}} className="nftCard">                    
                            <div style={{position: "relative", width: "150px", height: "400px", padding: "20px 0", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "space-between"}}>
                                {hatSlot !== null ?
                            ...
                            <div style={{position: "relative", width: "300px", height: "fit-content", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start"}}>
                                <div style={{width: "100%", marginBottom: "10px", display: "flex", flexDirection: "row", alignItems: "flex-start", justifyContent: "space-around"}}>
                                    <div>{address !== null ? address.slice(0, 4) + "..." + address.slice(-4) : ""}</div>
                                    {isStakeNow !== null ?
                                        <>
                                            {isStakeNow ?
                                                <div style={{display: "flex", flexDirection: "row"}} >
