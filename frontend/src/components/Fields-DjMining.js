                                        ...
                                        {nft.map((item, index) => (
                                            <div className="nftCard" style={{margin: "20px 10px", padding: "30px 20px"}} key={index}>
                                                ...
                                                <div style={{display: "flex", alignItems: "center", justifyContent: "center"}}>
                                                    ...
                                                    <img src="/tokens/bafybeicfkse4uvkhhkrhfwtap4h3v5msef6lg3t3xvb2hspw3xd5wegzfi.png" width="20" alt="$DOIJIB"/>&nbsp;
                                                    <>DOIJIB/30 DAYS</>
                                                </div>
                                                <div style={{width: 300, padding: 20, border: "1px solid #dddade", borderRadius: 12, display: "flex", flexDirection: "row", alignItem: "center", justifyContent: "space-between"}}>
                                                    <div style={{lineHeight: 1.5, fontSize: "12px", textAlign: "left"}}>
                                                        ...
                                                        <div style={{display: "flex", alignItems: "center"}}>
                                                            <img src="/tokens/bafybeicfkse4uvkhhkrhfwtap4h3v5msef6lg3t3xvb2hspw3xd5wegzfi.png" width="30" alt="$DOIJIB"/>
