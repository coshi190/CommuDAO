                        ...
                        <div style={{margin: "20px", padding: "20px 0", width: "400px", height: "450px", boxShadow: "6px 6px 0 #00000040"}} className="nftCard">
                            <div style={{width: "85%", display: "flex", justifyContent: "space-between", marginTop: "10px"}}>
                                ...
                                >
                                    ...
                                    <img style={{width: "38px", height: "38px", marginLeft: "-10px"}} src="/tokens/bafkreiaayvrql643lox66vkdfv6uzaoq2c5aa5mq3jjp3c7v4asaxvvzla.png" alt="$CMM" />
                                </div>
                                <div
                                    style={{cursor: "crosshair"}}
                                    onClick={async () => {
                                ...
                                >
                                    <img style={{width: "38px", height: "38px", marginRight: "5px"}} src="/tokens/bafkreidcxukia62wzaaes6wpsdgpw3yjshrjm7nwijwldxdthkepsebumq.png" alt="$CMOS" />
                                </div>
                            </div>
