        ...
        <div className="nftCard" style={{alignItems: "center", justifyContent: "flex-start", height: "460px", margin: "20px 20px 20px 40px", boxShadow: "6px 6px 0 #00000040", border: "1px solid rgb(227, 227, 227)"}}>
            <div style={{marginTop: "10px", width: "100%", maxHeight: "350px", display: "flex", flexDirection: "column", alignItems: "flex-start", justifyContent: "space-between"}}>
                <div style={{height: "160px", width: "100%", display: "flex", alignItems: "flex-end", justifyContent: "center"}}>
                    <img src="/elements/bafybeifwrprsashfhjrlbwnyvw4cb6pquyokfs3xm3wl6rt6bdzynpzhkm.png" width="260" alt="NPC_Jazzi" />
                </div>
                {mode === 1 &&
                    <>
                            ...
                            <div style={{marginTop: "5px", width: "95%", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                                <div style={{width: "70%", display: "flex", flexDirection: "row"}}>
                                    ...
                                    <div style={{fontSize: "16px", marginLeft: "1px", display: "flex", alignItems: "center", letterSpacing: "1px"}} className="pixel">
                                        &nbsp;1
                                        {gasselected === "JDAO" && <>&nbsp;<img src="/tokens/bafkreia2bjrh7yw2vp23e5lnc6u75weg6nq7dzkyruggsnjxid6qtofeeq.png" width="22" alt="$JDAO"/> &nbsp;=&nbsp; <div className="emp">{priceJDAO}</div></>}
                                        {gasselected === "CU" && <>&nbsp;<img src="/tokens/bafkreidau3s66zmqwtyp2oimumulxeuw7qm6apcornbvxbqmafvq3nstiq.png" width="22" alt="$CU"/> &nbsp;=&nbsp; <div className="emp">{priceCU}</div></>}
                                        {gasselected === "SIL" && <>&nbsp;<img src="/tokens/bafkreigld4xmmrmu763t2vsju3tqhcodgxxsrmgvrlfhdjktgujgcmpmde.png" width="22" alt="$SIL"/> &nbsp;=&nbsp; <div className="emp">{priceSIL}</div></>}
                                        {gasselected === "GOLD" && <>&nbsp;<img src="/tokens/bafkreia4zjqhbo4sbvbkvlgnit6yhhjmvo7ny4ybobuee74vqlmziskosm.png" width="22" alt="$GOLD"/> &nbsp;=&nbsp; <div className="emp">{priceGOLD}</div></>}
                                        {gasselected === "JASP" && <>&nbsp;GWEI&nbsp;<img src="/tokens/bafkreidfl4mgyczqwl3gtunpherc5ri3qbfzm2vevdwcojmhpz3viubopy.png" width="22" alt="$JASP"/> &nbsp;=&nbsp; <div className="emp">{priceJASP}</div></>}
                                        {gasselected === "OS" && <>&nbsp;<img src="/tokens/bafkreico3y6ql5vudm35ttestwvffdacbp25h6t5ipbyncwr3qtzprrm5e.png" width="22" alt="$OS"/> &nbsp;=&nbsp; <div className="emp">{priceOS}</div></>}
                                        {gasselected === "PLAT" && <>&nbsp;<img src="/tokens/bafkreibf7vowyqjrcaeyslflrxxchel3b4qdpwxcxb34js2otg35vjkcaa.png" width="22" alt="$PLAT"/> &nbsp;=&nbsp; <div className="emp">{pricePLAT}</div></>}
                                        {gasselected === "PLUTO" && <>&nbsp;<img src="/tokens/QmSd6B1WnUtzVqJPmEXqFSEudrdqCAE3LPkU64tttYeFPw.png" width="22" alt="$PLUTO"/> &nbsp;=&nbsp; <div className="emp">{pricePLUTO}</div></>}
                                        {gasselected === "F.BTC" && <>&nbsp;<img src="/tokens/QmPieCpfHoce19DSB5Mv5GZmZeGHAUerJfgjX6NhgLYUVC.png" width="22" alt="$F.BTC"/> &nbsp;=&nbsp; <div className="emp">{priceFBTC}</div></>}
                                        {gasselected === "X4" && <>&nbsp;<img src="/tokens/Qma5JyeNz8ME6H1XFxJCF4HmduDSC8mqLqmUs3SaMJbwzh.png" width="22" alt="$X4"/> &nbsp;=&nbsp; <div className="emp">{priceX4}</div></>}
                                        {gasselected === "INF.POW" && <>&nbsp;<img src="/tokens/QmbEWVgF3ZRvmDEF3RLKf7XDFr4SE5q4VEWR7taCqNnbU6.png" width="22" alt="$INF.POW"/> &nbsp;=&nbsp; <div className="emp">{priceINFPOW}</div></>}
                        ...
                        <div style={{width: "98%", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between"}}>
                            ...
                            {gasselected === "JDAO" && 
                                <div style={{width: "30%", display: "flex", flexDirection: "row", alignItems: "center", cursor: "pointer"}} onClick={() => {const bal = {target: {value: jdaoBalance}}; handleSwapUni(4, bal); setInputSwap(jdaoBalance);}}>
                                    <img src="/tokens/bafkreia2bjrh7yw2vp23e5lnc6u75weg6nq7dzkyruggsnjxid6qtofeeq.png" width="22" alt="$JDAO"/>
                            ...
                            {gasselected === "PLUTO" && 
                                <div style={{width: "30%", display: "flex", flexDirection: "row", alignItems: "center", cursor: "pointer"}} onClick={() => {const bal = {target: {value: plutoBalance}}; handleSwapUni(8, bal); setInputSwap(plutoBalance);}}>
                                    <img src="/tokens/QmSd6B1WnUtzVqJPmEXqFSEudrdqCAE3LPkU64tttYeFPw.png" width="22" alt="$PLUTO"/>
                            ...
                            {gasselected === "F.BTC" && 
                                <div style={{width: "30%", display: "flex", flexDirection: "row", alignItems: "center", cursor: "pointer"}} onClick={() => {const bal = {target: {value: fbtcBalance}}; handleSwapUni(9, bal); setInputSwap(fbtcBalance);}}>
                                    <img src="/tokens/QmPieCpfHoce19DSB5Mv5GZmZeGHAUerJfgjX6NhgLYUVC.png" width="22" alt="$F.BTC"/>
                            ...
                            {gasselected === "X4" && 
                                <div style={{width: "30%", display: "flex", flexDirection: "row", alignItems: "center", cursor: "pointer"}} onClick={() => {const bal = {target: {value: x4Balance}}; handleSwapUni(10, bal); setInputSwap(x4Balance);}}>
                                    <img src="/tokens/Qma5JyeNz8ME6H1XFxJCF4HmduDSC8mqLqmUs3SaMJbwzh.png" width="22" alt="$X4"/>
                            ...
                            {gasselected === "INF.POW" && 
                                <div style={{width: "30%", display: "flex", flexDirection: "row", alignItems: "center", cursor: "pointer"}} onClick={() => {const bal = {target: {value: infpowBalance}}; handleSwapUni(11, bal); setInputSwap(infpowBalance);}}>
                                    <img src="/tokens/QmbEWVgF3ZRvmDEF3RLKf7XDFr4SE5q4VEWR7taCqNnbU6.png" width="22" alt="$INF.POW"/>
