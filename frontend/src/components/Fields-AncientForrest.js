...
const AncientForrest = ({ config, callMode, navigate, setisLoading, txupdate, setTxupdate, setisError, setErrMsg, erc721Abi, aurora721ABI, starterCMDSABI, uplevelCMDSABI, woodFieldABI, msgABI, cmdaoNameABI, pve01ABI, erc20Abi }) => {
    ...
    return (
        <>
            <div className="fieldBanner" style={{display: "flex", flexFlow: "row wrap", alignItems: "center", justifyContent: "space-between", textAlign: "left", backgroundImage: "url('/maps/bafybeib5stifg5jcqqxsy4kbwwb6xovei5biyspuzhlwrsng4i62ppwpwy.png')", backgroundRepeat: "no-repeat", backgroundSize: "cover", overflow: "scroll"}}>
                ...
                <div className="SubfieldBanner">
                    <img src="/tokens/bafkreidldk7skx44xwstwat2evjyp4u5oy5nmamnrhurqtjapnwqzwccd4.png" width="150" alt="$WOOD" />
                </div>
            </div>
                    ...
                    <div style={{minWidth: '50%', display: 'flex', justifyContent: 'flex-start', flexWrap: "wrap"}}>
                                            ...
                                            <div style={{justifyContent: "space-around", padding: "30px 20px", height: "500px", margin: "10px"}} className="nftCard" key={index}>
                                                ...
                                                <div style={{width: 300, padding: 20, border: "1px solid #dddade", borderRadius: 12, display: "flex", flexDirection: "row", alignItem: "center", justifyContent: "space-between"}}>
                                                    <div style={{lineHeight: 2, fontSize: "12px", textAlign: "left",}} className="bold">
                                                        ...
                                                        <div style={{fontSize: "10px"}} className="emp"><img src="/tokens/bafkreidldk7skx44xwstwat2evjyp4u5oy5nmamnrhurqtjapnwqzwccd4.png" width="12" alt="$WOOD"/> {item.RewardWood}</div>
                                                        <div style={{fontSize: "10px"}} className="emp"><img src="/tokens/bafkreiabbtn5pc6di4nwfgpqkk3ss6njgzkt2evilc5i2r754pgiru5x4u.png" width="12" alt="$CMJ"/> {item.RewardCmj}</div>
                                                    </div>
                                                    {item.RewardWood > 0 ?
                                    ...
                                    <>
                                        {address !== null ?
                                            <div className="nftCard" style={{justifyContent: "flex-start", padding: "30px 20px", height: "500px", margin: '10px'}}>
                                                <img src="https://gateway.pinata.cloud/ipfs/bafkreiaqwsxafpj3acgdjmvn4hfodrhj5vdeq4cdiqtaaekpjiuamzcbhq" width="150" alt="Can not load metadata." />
                        ...
                        {address !== null &&
                            <div style={{justifyContent: "space-around", padding: "30px 20px", height: "500px", margin: '10px'}} className="nftCard">
                                <img src='https://gateway.pinata.cloud/ipfs/bafybeiax35zfioffpmp3tlyjwdrz2dplldgm5qokqi5p3b76cmomtkfri4' width="150" alt="Can not load metadata." />
                                ...
                                <div style={{width: 300, padding: "5px 20px", border: "1px solid #dddade", borderRadius: 12, display: "flex", flexDirection: "row", alignItem: "center", justifyContent: "space-between"}}>
                                    <div style={{lineHeight: 2, fontSize: "12px", textAlign: "left",}} className="bold">
                                        Rewards
                                        <div style={{fontSize: "14px"}}><img src="/tokens/bafkreibf7vowyqjrcaeyslflrxxchel3b4qdpwxcxb34js2otg35vjkcaa.png" width="12" alt="$PLAT"/> 1 per defeat</div>
                                    </div>
