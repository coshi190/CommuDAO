        ...
        <>
            <div className="fieldBanner" style={{display: "flex", flexFlow: "row wrap", alignItems: "center", justifyContent: "space-between", textAlign: "left", overflow: "scroll"}}>
                ...
                <div className="SubfieldBanner">
                    {(code === '01' || houseId === '10026002') && <img src="https://gateway.pinata.cloud/ipfs/bafkreiatzl4wbuoxjjrbeicqgm7xklq532mkqrpxen4bvtbn5q46zyawyy" height="150" alt="LAND.A" />}
                    {(code === '02' || houseId === '10026006' || houseId === '10026010') && <img src="https://gateway.pinata.cloud/ipfs/bafkreidtwbjkybihrt5i2zfy7fx2ixsgjerganenyyxtnidnlih7el7usq" height="150" alt="LAND.B" />}
                    {(code === '03' || houseId === '10026011') && <img src="https://gateway.pinata.cloud/ipfs/bafkreiago24hri42hnmirrohbjxmkwdpl4csybfox3ounsql4by7qu3k6q" height="150" alt="LAND.C" />}
                </div>
            </div>
